...
class Timer {
 ...
 public:
  ...
  Timer() : time_(0.0), accumulated_(0.0) { start(); }
  ...
  inline void resume() { gettimeofday(&start_time_, NULL); }
...
class DeBuger {
 ...
 private:
  ...
  std::string
      trace_name_;  //<! name of the thread that started the performance monitor
