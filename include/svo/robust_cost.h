...
// estimates scale by fitting a t-distribution to the data with the given
// degrees of freedom
...
/**
 * Interface for weight functions. A weight function is the first derivative of
 * a symmetric robust function p(sqrt(t)).
 * The errors are assumed to be normalized to unit variance.
 *
 * See:
 *   "Lucas-Kanade 20 Years On: A Unifying Framework: Part 2" - Page 23,
 * Equation (54)
 */
